...
print(f"{red}██║  ██║   ██║   ███████╗")
print(f"{red}╚═╝  ╚═╝   ╚═╝   ╚══════╝")
print(f"{green}Tools Created By : @RyzWp | Riannzx")
print(f"{green}Credit : @Tiktok : Riannzx !")
print(f"{green}Community : discord.gg/indomerdeka")
print(f"{yellow}--------------------------------------------------------------------------------")
	...
	if response != '':
		...
		if parser['code'] == 401:
			...
			if "apiError" in str(backend_data):
				...
				print(f'{yellow}[⌛]PLEASE WAIT • Ryz Wp Is Thinking')
				print(f'{red}▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬◥◣◆◢◤▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬')
